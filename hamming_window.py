...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 31 06:25:15 2018
...
def plt_preemphasis(audio_path):
...
def plt_periodogram(audio_path):
    y , sr = librosa.load(audio_path)
    f , p  = signal.periodogram(y,sr,nfft = 512)
    plt.semilogy(f, p)
